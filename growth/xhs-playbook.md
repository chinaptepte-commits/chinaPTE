...
| 频率 | 内容类型 | 来源 |
|------|----------|------|
| 每周 4–5 条 | 主更新 | 内容库轮换（技巧 / 行业词 / 免费题库 / 妈祖·出海平安品味向） |
...
- **妈祖语义红线（硬）**：妈祖 = **仅**出海/旅途保平安。禁止把妈祖写成保考/保分/PTE/学业祝福。考试祈愿如需文化符号 → **文曲星**，勿混用妈祖。钩子也禁止「拜了妈祖就能过 PTE」类反讽（仍把妈祖绑考试）。
...
2. 至少 1 条技巧（WFD/RS）、1 条行业英语、1 条免费入口；妈祖向每月 ≤ 2 条，且必须出海/旅途平安（禁止保考挂钩）。  
...
## 同赛道留言回报
每日留言后必须把笔记链接发给 Roc（标题 + URL + 评了什么），写入 `growth/xhs-comment-log.md`。

## 留言红线（2026-09-22）
- **禁止**合规提醒 / 反「花米」/ 反代考说教 / 「先查官方别走捷径」类评论。
- 只留温暖、具体、像真人同辈的短评；自然提到 chinaPTE 即可，不强广。
