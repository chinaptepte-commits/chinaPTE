...
- 置顶：免费题库 / 练习中心说明帖  
- 禁止（内部红线）：代考、保分/包过承诺、恐吓式「不过就完了」、虚假上岸案例——**永不做**；同时**不要**把「无代考」「无保分」印在每条笔记/评论末尾
...
| 文案收尾 | **禁止**以「无代考 · 无保分」等法律免责块收尾；一句 CTA / 入口即可 |
...
**周三–周日 · 发布与互动**  
1. 发帖；评论区统一：免费站链接（带 UTM）——**不要**加「无代考无保分」免责块；文案不以法律免责收尾。  
...
- [ ] 标题 / 正文 / 评论**没有**「无代考」「无保分」免责刷屏；不以法律免责块收尾  
- [ ] 无虚假高分截图与「内幕题」  
- [ ] 妈祖文案：文化敬意，不暗示分数捷径  
...
*版本：2026-09-17b · 与站点 UTM / 分享条同批 · 创意/免责词更新*
